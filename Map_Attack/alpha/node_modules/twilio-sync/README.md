...
Usage
-----
To use the library, you need to generate an [Access Token](https://www.twilio.com/docs/api/sync/identity-and-access-tokens) and pass it to the Sync Client constructor.
...
```
// Obtain a JWT access token: https://www.twilio.com/docs/api/sync/identity-and-access-tokens
...
For more code examples for Documents and other Sync objects, refer to the [SDK API Docs](https://media.twiliocdn.com/sdk/js/sync/v0.7/docs):
* [Documents](https://media.twiliocdn.com/sdk/js/sync/v0.7/docs/Document.html)
* [Lists](https://media.twiliocdn.com/sdk/js/sync/v0.7/docs/List.html)
* [Maps](https://media.twiliocdn.com/sdk/js/sync/v0.7/docs/Map.html)
* [Message Streams](https://media.twiliocdn.com/sdk/js/sync/v0.7/docs/Stream.html)

Changelog
---------
See this [link](https://www.twilio.com/docs/api/sync/sync-javascript-sdk-changelog#version-history-changelog).
