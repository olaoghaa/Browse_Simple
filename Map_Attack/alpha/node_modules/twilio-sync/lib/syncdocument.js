...
class SyncDocument extends entity_1.SyncEntity {
    ...
    setTtl(ttl) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const response = yield this._postUpdateToServer({ ttl });
    ...
    _setUnconditionally(value, ttl) {
        return __awaiter(this, void 0, void 0, function* () {
            let result = yield this._postUpdateToServer({ data: value, revision: undefined, ttl });
    ...
    _setWithIfMatch(mutatorFunction, ttl) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (data) {
                ...
                try {
                    let result = yield this._postUpdateToServer({ data, revision, ttl });
                    this._handleSuccessfulUpdateResult(result);
                    return this.value;
                }
                catch (error) {
                    if (error.status === 412) {
                        yield this._softSync();
    ...
    _postUpdateToServer(request) {
        return __awaiter(this, void 0, void 0, function* () {
            if (!this.isDeleted) {
                ...
                try {
                    const response = yield this.services.network.post(this.uri, requestBody, ifMatch);
                    return {
