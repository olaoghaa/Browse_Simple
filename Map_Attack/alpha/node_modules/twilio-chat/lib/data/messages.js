...
class Messages extends events_1.EventEmitter {
    ...
    unsubscribe() {
        return __awaiter(this, void 0, void 0, function* () {
            if (this.messagesListPromise) {
                let entity = yield this.messagesListPromise;
                entity.close();
                this.messagesListPromise = null;
            }
        });
     ...
     * @returns Returns promise which can fail
     */
    sendMedia(mediaContent, attributes = {}) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (mediaContent instanceof FormData) {
                ...
                media = yield this.services.mcsClient.postFormData(mediaContent);
            }
            else {
                ...
                media = yield this.services.mcsClient.post(mediaOptions.contentType, mediaOptions.media);
            }
