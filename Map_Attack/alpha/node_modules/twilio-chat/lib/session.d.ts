...
declare class Session {
    ...
    private handleContextUpdate(updatedContext);
    initialize(): Promise<Session>;
    /**
     * Sends the command to the server
     * @returns Promise the promise, which is being fulfilled only when service will reply
     */
    addCommand(action: string, params: Object): Promise<{}>;
    /**
     * @private
     */
    private processCommand(action, params, createSessionIfNotFound?);
    /**
     * @private
     */
    ...
    getConsumptionReportInterval(): Promise<any>;
    getHttpCacheInterval(): Promise<any>;
}
