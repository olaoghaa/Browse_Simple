...
class Session {
    ...
    getSessionLinks() {
        return __awaiter(this, void 0, void 0, function* () {
            let info = yield this.sessionInfo.promise;
            return {
    ...
    getConsumptionReportInterval() {
        return __awaiter(this, void 0, void 0, function* () {
            let context = yield this.getSessionContext();
            ...
            try {
                return Durational.fromString(consumptionIntervalToUse);
            }
            catch (e) {
                ...
                return Durational.fromString(this.config.consumptionReportIntervalDefault);
            }
        });
    }
    getHttpCacheInterval() {
        return __awaiter(this, void 0, void 0, function* () {
            let context = yield this.getSessionContext();
