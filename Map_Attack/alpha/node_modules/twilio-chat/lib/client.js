...
class Client extends events_1.EventEmitter {
    constructor(token, options) {
        ...
        this.config = new configuration_1.Configuration(null, this.options);
        this.options.twilsockClient = this.options.twilsockClient || new TwilsockClient(token, this.options);
        ...
        this.services.emsClient = this.options.emsClient;
        ...
        this.services.users.on('userUpdated', this.emit.bind(this, 'userUpdated'));
        ...
        this.channelsPromise = this.sessionPromise.then(() => {
            ...
            this.channels.on('channelUpdated', this.emit.bind(this, 'channelUpdated'));
            this.channels.on('memberJoined', this.emit.bind(this, 'memberJoined'));
            this.channels.on('memberLeft', this.emit.bind(this, 'memberLeft'));
            this.channels.on('memberUpdated', this.emit.bind(this, 'memberUpdated'));
            this.channels.on('messageAdded', this.emit.bind(this, 'messageAdded'));
            this.channels.on('messageUpdated', this.emit.bind(this, 'messageUpdated'));
    ...
    subscribeToPushNotifications(channelType) {
        [notificationtypes_1.NotificationTypes.NEW_MESSAGE,
            ...
            .forEach(messageType => {
            this.services.notificationClient.subscribe(messageType, channelType);
        });
    }
    initialize() {
        return __awaiter(this, void 0, void 0, function* () {
            let response = yield this.services.emsClient.setToken(this.fpaToken);
            ...
            yield this.services.typingIndicator.initialize();
        });
    }
    /**
    ...
    shutdown() {
        return __awaiter(this, void 0, void 0, function* () {
            yield this.services.twilsockClient.disconnect();
        });
    }
    /**
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return this.services.emsClient.setToken(token)
                ...
                return this.services.twilsockClient.updateToken(token)
                    .then(() => this.services.syncClient.updateToken(token))
                    .then(() => this.services.notificationClient.updateToken(token))
                    .then(() => this.services.mcsClient.updateToken(token))
                    .then(() => this.sessionPromise)
                    .then(() => rtdToken);
            })
                .then(rtdToken => {
                this.config.updateToken(rtdToken);
                this.fpaToken = token;
                return this;
            });
        });
    ...
    static parsePushNotification(notificationPayload) {
        ...
        if (typeof notificationPayload.aps !== 'undefined') {
            ...
            let badge = apsPayload.badge || null;
            let sound = apsPayload.sound || null;
            let action = apsPayload.category || null;
