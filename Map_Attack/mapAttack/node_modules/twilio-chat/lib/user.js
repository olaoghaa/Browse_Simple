...
class User extends events_1.EventEmitter {
    ...
    _fetch() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            this.promiseToFetch = this.services.syncClient.map({ id: this.state.entityName, mode: 'open_existing', includeItems: true })
                .then(map => {
                this.entity = map;
                map.on('itemUpdated', args => this._update(args.item.key, args.item.value));
                return Promise.all([
    ...
    updateAttributes(attributes) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield this.services.session.addCommand('editUserAttributes', {
    ...
    updateFriendlyName(friendlyName) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield this.services.session.addCommand('editUserFriendlyName', {
                username: this.state.identity,
