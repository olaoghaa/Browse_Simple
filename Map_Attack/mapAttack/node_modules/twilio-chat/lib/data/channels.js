...
class Channels extends events_1.EventEmitter {
    ...
    addChannel(options) {
        return __awaiter(this, void 0, void 0, function* () {
            let response = yield this.services.session.addCommand('createChannel', {
            ...
            if (existingChannel) {
                yield existingChannel._subscribe();
    ...
    fetchChannels() {
        this.getMap()
            .then((map) => __awaiter(this, void 0, void 0, function* () {
            ...
            let upserts = [];
            let paginator = yield this.services.syncList.getPage();
            let items = paginator.items;
            items.forEach(item => {
                upserts.push(this.upsertChannel('synclist', item.channel_sid, item.descriptor));
            });
            while (paginator.hasNextPage) {
                paginator = yield paginator.nextPage();
