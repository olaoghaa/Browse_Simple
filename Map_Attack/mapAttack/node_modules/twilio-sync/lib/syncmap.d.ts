...
export declare class SyncMap extends SyncEntity {
    ...
    private _getItemFromServer(key);
    /**
    ...
    private _putItemUnconditionally(key, data, ttl);
    private _putItemWithIfMatch(key, mutatorFunction, ttl);
    private _putItemToServer(key, data, ifMatch, ttl);
    /**
    ...
    private _handleItemMutated(key, url, lastEventId, revision, value, dateUpdated, dateExpires, added, remote);
