...
class SyncMap extends entity_1.SyncEntity {
    ...
    _putItemUnconditionally(key, data, ttl) {
        return __awaiter(this, void 0, void 0, function* () {
            const result = yield this._putItemToServer(key, data, undefined, ttl);
    ...
    _putItemWithIfMatch(key, mutatorFunction, ttl) {
        return __awaiter(this, void 0, void 0, function* () {
            const currentItem = yield this.get(key)
                .catch(error => {
                if (error.status === 404) {
            ...
            if (data) {
                ...
                try {
                    const result = yield this._putItemToServer(key, data, ifMatch, ttl);
                    const item = result.item;
                    this._handleItemMutated(item.key, item.url, item.last_event_id, item.revision, item.data, item.date_updated, item.date_expires, result.added, false);
                    return this.cache.get(item.key);
                }
                    ...
                    if (error.status === 412) {
                        yield this._getItemFromServer(key);
    ...
    _putItemToServer(key, data, ifMatch, ttl) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                const response = yield this.services.network.put(url, requestBody, ifMatch);
    ...
    setItemTtl(key, ttl) {
        return __awaiter(this, void 0, void 0, function* () {
            utils_1.validateMandatoryTtl(ttl);
            let existingItem = yield this.get(key);
            const requestBody = { ttl };
