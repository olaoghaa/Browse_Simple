...
class SyncList extends entity_1.SyncEntity {
    ...
    _addOrUpdateItemOnServer(url, data, ifMatch, ttl) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let response = yield this.services.network.post(url, requestBody, ifMatch);
    ...
    push(value, itemMetadata) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let item = yield this._addOrUpdateItemOnServer(this.links.items, value, undefined, ttl);
    ...
    _updateItemUnconditionally(index, data, ttl) {
        return __awaiter(this, void 0, void 0, function* () {
            let existingItem = yield this.get(index);
            const itemDescriptor = yield this._addOrUpdateItemOnServer(existingItem.uri, data, undefined, ttl);
    ...
    _updateItemWithIfMatch(index, mutatorFunction, ttl) {
        return __awaiter(this, void 0, void 0, function* () {
            const existingItem = yield this.get(index);
            const data = mutatorFunction(utils_1.deepClone(existingItem.value));
            if (data) {
                const ifMatch = existingItem.revision;
                try {
                    const itemDescriptor = yield this._addOrUpdateItemOnServer(existingItem.uri, data, ifMatch, ttl);
                    this._handleItemMutated(index, itemDescriptor.url, itemDescriptor.last_event_id, itemDescriptor.revision, itemDescriptor.data, itemDescriptor.date_updated, itemDescriptor.date_expires, false, false);
                    return this.cache.get(index);
                }
                catch (error) {
                    if (error.status === 412) {
                        yield this._getItemFromServer(index);
    ...
    setTtl(ttl) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                const response = yield this.services.network.post(this.uri, requestBody);
    ...
    setItemTtl(index, ttl) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let existingItem = yield this.get(index);
            const requestBody = { ttl };
            const response = yield this.services.network.post(existingItem.uri, requestBody);
