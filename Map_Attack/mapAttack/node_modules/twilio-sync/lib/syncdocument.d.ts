...
declare class SyncDocument extends SyncEntity {
     ...
     * @private
     */
    private _setUnconditionally(value, ttl?);
    /**
     * @private
     */
    private _setWithIfMatch(mutatorFunction, ttl?);
    /**
     * @private
     */
    private _handleSuccessfulUpdateResult(result);
    /**
     * @private
     */
    private _postUpdateToServer(request);
    /**
